...
// ─── Tenant Profiles (Feature: Leietakeroversikt) ────────────────────────
// Inspired by husleie.no & hybel.no tenant management features
export const demoTenants = [
  {
    id: 'tenant-1',
    name: 'Erik Hansen',
    email: 'erik.hansen@email.no',
    phone: '+47 912 34 567',
    ...
    lease_id: 'lease-1',
    property_id: 'prop-1',
    emergency_contact: 'Kari Hansen, +47 987 65 432',
    notes: 'Stabil leietaker, alltid betaler i tide.',
    avatar_color: '#2563eb',
    employer: 'DNB ASA',
  ...
  },
  {
    ...
    lease_id: 'lease-2',
    property_id: 'prop-2',
    emergency_contact: 'Per Olsen, +47 976 54 321',
    notes: 'Lang leietaker. Fornøyd med boligen.',
    avatar_color: '#16a34a',
    employer: 'Telenor',
  ...
  },
  {
    ...
    lease_id: 'lease-3',
    property_id: 'prop-3',
    emergency_contact: 'Anna Berg, +47 965 43 210',
    notes: 'Noen forsinkede betalinger, ellers ok.',
    avatar_color: '#f59e0b',
    employer: 'Equinor',
  ...
  },
  {
    ...
    lease_id: 'lease-4',
    property_id: 'prop-4',
    emergency_contact: 'Ole Larsen, +47 954 32 109',
    notes: '',
    avatar_color: '#8b5cf6',
  ...
  },
  {
    ...
    lease_id: 'lease-1-old',
    property_id: 'prop-1',
    emergency_contact: 'Lise Johansen, +47 943 21 098',
    notes: 'Tidligere leietaker. Flyttet ut 2023.',
    avatar_color: '#6b7280',
    employer: 'Selvansatt',
