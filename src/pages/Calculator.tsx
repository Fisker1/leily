      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Analyser lønnsomheten og risikoen ved eiendomsinvestering
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Card className="shadow-medium">
            ...
            <CardContent className="space-y-6">
              ...
              {canShowResults && !showModules && (
                <Button 
                  onClick={() => setShowModules(true)} 
                  className="w-full"
                  size="lg"
                >
                  Vis avanserte analysemoduler
          ...
          <div className="space-y-6">
            ...
            {!canShowResults && (
              <Card className="shadow-medium">
                ...
                <div className="text-center space-y-4">
                  <CalcIcon className="h-16 w-16 text-muted-foreground mx-auto" />
                  <p className="text-muted-foreground">
                    Fyll inn eiendomsdetaljene for å se analysen
                  </p>
                </div>
                </CardContent>
              </Card>
        ...
        {/* Advanced Modules */}
        {showModules && canShowResults && (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold text-foreground">Avanserte analysemoduler</h2>
              <p className="text-muted-foreground">
                Velg moduler for dybdeanalyse av investeringen
              </p>
            </div>
